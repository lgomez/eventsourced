...
a.rename('Peter');
a.save();
console.log(Entity.inspect(a));


console.log('CREATING INSTACE B');
const b = new TestEntity(Entity.snapshot(a));
// i.save();
console.log(b.name);
console.log(Entity.inspect(b));

// tap.equals(Entity.version(i), 0, 'Instance version should be 0');
//
